...
// MODIFIE ICI : taille emoji agrandie
function EmojiPickerEmoji({
  ...
  return (
    <button
      {...props}
      className={cn(
        // taille bouton + texte emoji augmentée
        "data-[active]:bg-accent flex size-12 items-center justify-center rounded-sm text-4xl",
        className
      )}
  ...
  return (
    ...
    >
      ...
      <EmojiPickerPrimitive.List
        ...
        components={{
          Row: EmojiPickerRow,
          Emoji: EmojiPickerEmoji, // <-- Le composant modifié
    ...
    >
      <EmojiPickerPrimitive.ActiveEmoji>
        {({ emoji }) =>
          emoji ? (
            <>
              {/* MODIFIE ICI aussi pour footer si tu veux : taille emoji agrandie */}
              <div className="flex size-12 flex-none items-center justify-center text-5xl">
                {emoji.emoji}
              </div>
